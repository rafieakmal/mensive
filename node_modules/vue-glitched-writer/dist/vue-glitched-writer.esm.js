import { defineComponent, ref, computed, watch, onMounted, openBlock, createBlock, resolveDynamicComponent } from 'vue';
...
var script = defineComponent({
  ...
  setup(props, {
    ...
    () => cjs.presets[props.preset] ?? {}),
      ...
      return ['number', 'boolean', 'function'].includes(typeof ((_props$queue2 = props.queue) === null || _props$queue2 === void 0 ? void 0 : _props$queue2.loop)) ? props.queue.loop : undefined;
    });
    /**
    ...
    const computedOptions = computed(() => ({ ...preset.value,
      ...props.options
    }));
    ...
    watch(() => props.text, write); // Pause and Play

    watch(() => props.pause, pause => pause ? writer.value.pause() : writer.value.play());
    /**
     * Mounted hook
     */
    ...
    onMounted(() => {
      ...
      writer.value = cjs.create(element.value, computedOptions.value);
      ...
      writer.value.addCallback('finish', (string, data) => emit('finish', string, data)); // Write initial text if props.appear is true
...
var glyphs = cjs.glyphs;
var presets$1 = cjs.presets;
var wait = cjs.wait;
export { cjs as GlitchedWriter, entry_esm as default, glyphs, presets$1 as presets, wait };
